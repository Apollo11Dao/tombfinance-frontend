...
const MigrationDisclaimerModal: React.FC<MigrationDisclaimerModalProps> = ({ onConfirm, onDismiss }) => {
  ...
  return (
    <Modal>
      ...
      <div>
        <StyledText>
          Due to the upgrade, all Parlour functionalities other than [Settle and withdraw] has been disabled for users
          who staked in legacy Parlour. Please withdraw all balances from the previous parlour after the update.
        </StyledText>
      </div>
      <ModalActions>
